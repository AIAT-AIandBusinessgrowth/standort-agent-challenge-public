...
> 💡 **Achtung Skalen & Richtung:** Die Felder stehen in **unterschiedlichen Einheiten** (Anteile `0`–`1`, Dichte/ÖV `0`–`10`, Mietindex in €/m²) — und sie zeigen **nicht alle in dieselbe Richtung**: ein hoher `mietindex_eur_m2` ist ein **Kosten-/Risiko-Faktor** (eher schlechter), eine hohe `poi_dichte` oder ein hoher `oev_score` ist ein **Vorteil** (eher besser). Wie du beides auf eine vergleichbare Basis bringst, bevor du gewichtet zusammenrechnest, ist deine Designentscheidung.
